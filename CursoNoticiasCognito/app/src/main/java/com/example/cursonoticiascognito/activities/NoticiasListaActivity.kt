...
import com.example.cursonoticiascognito.adapter.NoticiaAdapter
...
class NoticiasListaActivity : AppCompatActivity() {
    ...
    inner class getNoicias : AsyncTask<Void, Void, String>() {
        ...
        override fun onPostExecute(results: String?) {
            ...
            try {
                ...
                rvNoticias.adapter = NoticiaAdapter(this@NoticiasListaActivity, listaNoticias)
